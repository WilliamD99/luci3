...
export default function SliderContent({
    ...
    return (
        <>
            <div className='slider-content absolute z-50 left-80 top-1/2 -translate-y-full mt-10'>
                <div className='slider-content--title overflow-hidden'>
                    <p ref={titleRef} className={`text-white ${headingFont.className}`}>{items[index].title}</p>
                </div>
                <div className='slider-content--subTitle overflow-hidden'>
                    <p ref={subTitleRef} className='text-white'>{items[index].subTitle}</p>
                </div>
            </div>
        </>
    )
