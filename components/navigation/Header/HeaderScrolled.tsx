...
const HeaderScrolled = ({ isActive }: Props, ref: any) => {
    ...
    const handleChangeColor = useCallback(debounce(() => {
        const homeWorkComponent = document.getElementById('home_work');
        const homeWorkInMotionComponent = document.getElementById('home_workInMotion');
        const homeInTheMediaComponent = document.getElementById('home_inTheMedia');
    ...
    useEffect(() => {
        if (btnOpenRef.current && btnCloseRef.current && dropdownMenuRef.current && ref.current) {
                        ...
                        <ul className='navigation flex flex-col'>
                            <div className='link_wrapper overflow-hidden'>
                                <div className='navigation_link overflow-hidden'>
                                    <Link href="/work" className={`underline-effect ${headingFont.className}`}>Work</Link>
                                </div>
                            </div>
                            <div className='link_wrapper overflow-hidden'>
                                <div className='navigation_link overflow-hidden'>
