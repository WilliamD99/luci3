...
const HeaderScrolled = ({ isActive }: Props) => {
  ...
  return (
    <>
        <div ref={headerScrolledRef} id="navigation_header--scrolled" className={`fixed z-50 flex flex-row justify-between items-center w-full px-16 py-8 ${isActive ? "active" : ""}`}>
            <div className='relative h-16 w-16'>
                <svg viewBox="0 0 64 66" fill="none" xmlns="http://www.w3.org/2000/svg" className="brandmark h-full w-full" data-v-1932cced="" style={{opacity: 1, visibility: "inherit"}}>
